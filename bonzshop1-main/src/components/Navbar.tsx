...
import { Link, useNavigate } from 'react-router-dom';
  import { Code2, LogOut, Shield, User, FolderOpen, Gift, Menu, X, ShoppingBag, Coins, Store, FileText, Sparkles, MessageCircle, Skull, History } from 'lucide-react';
              ...
              <>
                ...
                {/* Coin Balance */}
                 <div className="flex items-center">
                   <Link to="/buy-coins">
                     <Button variant="outline" size="sm" className="gap-2 border-primary/30 hover:bg-primary/10 hover:border-primary/50 group rounded-r-none border-r-0">
                   ...
                   <Link to="/coin-history">
                     <Button variant="outline" size="sm" className="border-primary/30 hover:bg-primary/10 hover:border-primary/50 rounded-l-none px-2">
                ...
                >
                  ...
                  <span className="hidden lg:inline max-w-[120px] truncate">{displayName || user.email?.split('@')[0]}</span>
                </Link>
